export default function LatestProducts() {
    return 	<section class="suite_two_area">
			<div class="container">
				<div class="row">
									...
									<div class="single_suite_img1 hover_img effect">
										...
										<div class="cc_hover">
											<ul class="cc_hover_ul">
												...
												<li class="h_search"><a data-toggle="modal" data-target="#myModal25" class="fa fa-search" href=""></a></li>
											</ul>
										</div>
									...
									<div class="single_suite_img hover_img effect">
										...
										<div class="cc_hover">
											<ul class="cc_hover_ul">
												<li class="h_cart"><a class="fa fa-shopping-cart" href="cart.html"></a></li>
												<li class="h_heart"><a class="fa fa-heart" href="#"></a></li>
												<li class="h_search"><a data-toggle="modal" data-target="#myModal26" class="fa fa-search" href=""></a></li>
											</ul>
										</div>
										<div class="common_overlay"></div>
									</div>
									...
									<div class="single_suite_img hover_img effect">
										...
										<div class="cc_hover">
											<ul class="cc_hover_ul">
												<li class="h_cart"><a class="fa fa-shopping-cart" href="cart.html"></a></li>
												<li class="h_heart"><a class="fa fa-heart" href="#"></a></li>
												<li class="h_search"><a data-toggle="modal" data-target="#myModal27" class="fa fa-search" href=""></a></li>
											</ul>
										</div>
										<div class="common_overlay"></div>
									</div>
									...
									<div class="single_suite_img hover_img effect">
										...
										<div class="cc_hover">
											<ul class="cc_hover_ul">
												<li class="h_cart"><a class="fa fa-shopping-cart" href="cart.html"></a></li>
												<li class="h_heart"><a class="fa fa-heart" href="#"></a></li>
												<li class="h_search"><a data-toggle="modal" data-target="#myModal28" class="fa fa-search" href=""></a></li>
											</ul>
										</div>
										<div class="common_overlay"></div>
									</div>
