export default function SimilarProducts() {
    return <section class="suite_one_area">
			<div class="container">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="row">
							<div class="col-md-3 col-sm-3 col-xs-12">
									...
									<div class="single_suite_img1 hover_img effect">
										...
										<div class="cc_hover">
											<ul class="cc_hover_ul">
												...
												<li class="h_search"><a data-toggle="modal" data-target="#myModal71" class="fa fa-search" href=""></a></li>
											</ul>
										</div>
								...
								{/* <!-- Modal --> */}
									<div class="modal fade" id="myModal71" tabindex="-1" role="dialog" aria-hidden="true">
							...
							<div class="col-md-3 col-sm-3 col-xs-12">
									...
									<div class="single_suite_img hover_img effect">
										...
										<div class="cc_hover">
											<ul class="cc_hover_ul">
												<li class="h_cart"><a class="fa fa-shopping-cart" href="cart.html"></a></li>
												<li class="h_heart"><a class="fa fa-heart" href="#"></a></li>
												<li class="h_search"><a data-toggle="modal" data-target="#myModal72" class="fa fa-search" href=""></a></li>
											</ul>
										</div>
										<div class="common_overlay"></div>
									</div>
								...
								{/* <!-- Modal --> */}
									<div class="modal fade" id="myModal72" tabindex="-1" role="dialog" aria-hidden="true">
									  <div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-body">
												<div class="m_img_left">
							...
							<div class="col-md-3 col-sm-3 col-xs-12">
									...
									<div class="single_suite_img hover_img effect">
										...
										<div class="cc_hover">
											<ul class="cc_hover_ul">
												<li class="h_cart"><a class="fa fa-shopping-cart" href="cart.html"></a></li>
												<li class="h_heart"><a class="fa fa-heart" href="#"></a></li>
												<li class="h_search"><a data-toggle="modal" data-target="#myModal73" class="fa fa-search" href=""></a></li>
											</ul>
										</div>
										<div class="common_overlay"></div>
									</div>
								...
								{/* <!-- Modal --> */}
									<div class="modal fade" id="myModal73" tabindex="-1" role="dialog" aria-hidden="true">
									  <div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-body">
												<div class="m_img_left">
							...
							<div class="col-md-3 col-sm-3 col-xs-12">
								<div class="single_suite">
									<div class="single_suite_img hover_img effect">
										...
										<div class="cc_hover">
											<ul class="cc_hover_ul">
												<li class="h_cart"><a class="fa fa-shopping-cart" href="cart.html"></a></li>
												<li class="h_heart"><a class="fa fa-heart" href="#"></a></li>
												<li class="h_search"><a data-toggle="modal" data-target="#myModal74" class="fa fa-search" href=""></a></li>
											</ul>
										</div>
										<div class="common_overlay"></div>
									</div>
									...
									{/* <!-- Modal --> */}
									<div class="modal fade" id="myModal74" tabindex="-1" role="dialog" aria-hidden="true">
									  <div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-body">
												<div class="m_img_left">
