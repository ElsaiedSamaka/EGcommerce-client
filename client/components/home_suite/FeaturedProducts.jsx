									...
									<div className="single_suite_img1 hover_img effect">
										...
										<div className="cc_hover">
											<ul className="cc_hover_ul">
												...
												<li className="h_search"><a data-toggle="modal" data-target="#myModal21" className="fa fa-search" href=""></a></li>
											</ul>
										</div>
									...
									<div className="single_suite_img hover_img effect">
										...
										<div className="cc_hover">
											<ul className="cc_hover_ul">
												<li className="h_cart"><a className="fa fa-shopping-cart" href="cart.html"></a></li>
												<li className="h_heart"><a className="fa fa-heart" href="#"></a></li>
												<li className="h_search"><a data-toggle="modal" data-target="#myModal22" className="fa fa-search" href=""></a></li>
											</ul>
										</div>
										<div className="common_overlay"></div>
									</div>
									...
									<div className="single_suite_img hover_img effect">
										...
										<div className="cc_hover">
											<ul className="cc_hover_ul">
												<li className="h_cart"><a className="fa fa-shopping-cart" href="cart.html"></a></li>
												<li className="h_heart"><a className="fa fa-heart" href="#"></a></li>
												<li className="h_search"><a data-toggle="modal" data-target="#myModal23" className="fa fa-search" href=""></a></li>
											</ul>
										</div>
										<div className="common_overlay"></div>
									</div>
									...
									<div className="single_suite_img hover_img effect">
										...
										<div className="cc_hover">
											<ul className="cc_hover_ul">
												<li className="h_cart"><a className="fa fa-shopping-cart" href="cart.html"></a></li>
												<li className="h_heart"><a className="fa fa-heart" href="#"></a></li>
												<li className="h_search"><a data-toggle="modal" data-target="#myModal24" className="fa fa-search" href=""></a></li>
											</ul>
										</div>
										<div className="common_overlay"></div>
									</div>
